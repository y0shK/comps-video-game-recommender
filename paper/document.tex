...
\begin{comment}
    ...
    https://dl.acm.org/doi/10.1145/1864708.1864721 - cited

    See this literature:

    https://dl.acm.org/doi/abs/10.1145/1328854.1328855 - "cosine similarity has proven to be a robust metric for scoring the similarity between two strings, and it is increasingly being used in complex queries" - database management but NOT natural language processing - cited
